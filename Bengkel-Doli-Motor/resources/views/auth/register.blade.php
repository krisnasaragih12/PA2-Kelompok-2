                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            <h6 class="section-subtitle ltn__secondary-color">//  Selamat Datang Di Doli Motor</h6>
                            <h1 class="section-title white-color">Daftar Akun</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        <h1 class="section-title">Daftarkan <br>Akun Anda</h1>
                        <p>Dengan mendaftarkan akun anda<br>
                             anda dapat mengakses semua fitur yang ada pada website ini</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="account-login-inner">
                        <form action="{{ url('do_register') }}" method="post" class="ltn__form-box contact-form-box">
                            @csrf
                            <input type="text" class="form-control @error('username') is-invalid @enderror" name="username" placeholder="Username" value="{{ old('username') }}" autocomplete="off">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Nama" value="{{ old('name') }}" autocomplete="off">
                            <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email" value="{{ old('email') }}" autocomplete="off">
                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Kata Sandi" value="{{ old('password') }}" autocomplete="off">
                            <div class="btn-wrapper">
                                <button class="theme-btn-1 btn reverse-color btn-block" type="submit">Daftarkan</button>
                            </div>
                        </form>
                        <div class="by-agree text-center">
                            <div class="go-to-btn mt-7">
                                <a href="{{ url('login') }}">Apakah anda sudah memiliki akun?</a>
                            </div>
                        </div>
                    </div>
                </div>
