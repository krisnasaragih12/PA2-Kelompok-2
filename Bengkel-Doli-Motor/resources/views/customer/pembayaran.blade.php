...
<head>
    ...
    <title>Pembayaran - Doli Motor</title>
                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title white-color">Pembayaran</h1>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-item input-item-name ltn__custom-icon">
                                                ...
                                                <input type="text" name="ltn__name" placeholder="Nama" required value="{{ Auth::user()->name }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="input-item input-item-phone ltn__custom-icon">
                                                <input type="text" name="ltn__phone" placeholder="Nomor Telepon" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-item">
                                                        <input required name='alamat' id='alamat' type="text" placeholder="House number and street name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-6">
                    <div class="ltn__checkout-payment-method mt-50">
                        ...
                        <div id="checkout_accordion_1">
                            <!-- card -->
                            <div class="card">
                                <input type="radio" value="E-Money" required name="payment_method" id="bayar-di-tempat" data-bs-toggle="collapse" data-bs-target="#faq-item-2-1" aria-expanded="false" style="position: absolute; top: 13px; left: 7px;"><label class="ltn__card" for="bayar-di-tempat">E-Money</label>
                                <div id="faq-item-2-1" class="collapse" data-parent="#checkout_accordion_1">
                                    <div class="card-body">
                                        <p><b>Dana :</b> 08126268356</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <input type="radio" required value="Via Bank" name="payment_method" id="via-bank" data-bs-toggle="collapse" data-bs-target="#faq-item-2-3" aria-expanded="false" style="position: absolute; top: 13px; left: 7px;"><label class="" for="via-bank">Via Bank</label>
                                <div id="faq-item-2-3" class="collapse" data-parent="#checkout_accordion_1">
                                    <div class="card-body">                    
                                        <p><b>Mandiri :</b> 1560009861578</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="theme-btn-1 btn btn-effect-1">Bayar Sekarang</button>
</form>
                    </div>
                </div>
            </div>
